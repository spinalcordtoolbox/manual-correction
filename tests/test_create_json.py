...
def test_update_json_generated_by_sct(tmp_path):
    """
    Test that the function update_json() updates a JSON file generated by SCT
    """
    # Create a temporary file for testing
    fname_label = "sub-001_ses-01_T1w_seg-manual.nii.gz"
    nifti_file = tmp_path / fname_label
    ...
    # Create custom metadata to imitate SCT output
    # Note: values are dummy and do not correspond to the actual SCT output
    custom_metadata = {'GeneratedBy': [{
        'Name': 'spinalcordtoolbox: sct_deepseg',
        'Version': '6.5',
